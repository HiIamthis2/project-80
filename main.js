...
function submit()
{
    ...
    var leght_of_name_of_student_array = name_of_the_student_array.length;
    console.log(leght_of_name_of_student_array);

    for (var k = 0; k < leght_of_name_of_student_array; k++)
    {
